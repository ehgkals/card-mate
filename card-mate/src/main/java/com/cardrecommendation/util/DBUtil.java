...
public class DBUtil {
    ...
    private static final String URL =
        "jdbc:mysql://localhost:3306/carddb?serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true&characterEncoding=UTF-8";
    private static final String USER = "root";      // 본인 계정
    private static final String PASSWORD = "1234";  // 본인 비번

    static {
        try {
            Class.forName(DRIVER_NAME); // MySQL 8+
